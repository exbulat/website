        ...
        <div class="col-md-8">
            <div class="card shadow-sm">
                <div class="card-header bg-white">
                    <h4 class="mb-0">Добавление вопроса в опрос "{{ $survey->title }}"</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('surveys.questions.store', $survey) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="scale_min" name="scale_min" value="{{ old('scale_min', 1) }}" min="1" max="99">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="scale_max" class="form-label">Максимальное значение</label>
                                        <input type="number" class="form-control" id="scale_max" name="scale_max" value="{{ old('scale_max', 10) }}" min="2" max="100">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('position') is-invalid @enderror" id="position" name="position" value="{{ old('position', $position) }}" min="1">
                            @error('position')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                <button type="submit" name="add_another" value="1" class="btn btn-outline-primary me-2">Сохранить и добавить ещё</button>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Если уже выбран тип при загрузке страницы (например, при ошибке валидации)
        if (typeSelect.value) {
